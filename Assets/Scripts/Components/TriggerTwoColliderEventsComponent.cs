...
{
    [AddComponentMenu("GameEngine/Mechanics/Component «Trigger Two Collider Events»")]
    public sealed class TriggerTwoColliderEventsComponent : MonoBehaviour, ITriggerTwoColliderEventsComponent
    {
